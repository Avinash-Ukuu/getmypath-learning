...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://www.getmypathlearning.com/" target="_blank" class="nav-link">Home</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                            <img height="30px" src="{{ asset('assets/frontend/images/default-male.jpg') }}"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="https://www.getmypathlearning.com/" target="_blank" class="brand-link">
                {{-- <img src="{{ asset('assets/frontend/images/GetMyPath.png') }}" alt="Get My Path Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8"> --}}
                <span class="brand-text font-weight-light ">Get My Path learning</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('assets/frontend/images/default-male.jpg')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
